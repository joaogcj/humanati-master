# VANE — pacote vetorial reconstruído

Status: **reconstrução baseada na prancha de referência**.

Os 32 pacotes recuperados não continham arquivos vetoriais editáveis desta marca. Este conjunto foi reconstruído a partir de `branding/reference-boards/vane-master-package.png` para viabilizar aplicações digitais e documentação. Ele não substitui um arquivo-fonte original aprovado pela direção de marca.
